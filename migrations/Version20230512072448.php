 ...
 */
final class Version20230512072448 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE vote (id INT AUTO_INCREMENT NOT NULL, question_id INT DEFAULT NULL, comment_id INT DEFAULT NULL, author_id INT NOT NULL, is_liked TINYINT(1) NOT NULL, INDEX IDX_5A1085641E27F6BF (question_id), INDEX IDX_5A108564F8697D13 (comment_id), INDEX IDX_5A108564F675F31B (author_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
